...
if( class_exists( 'WP_Customize_Control' ) ) {
	class drift_thinkup_customizer_customcontrol_radio_image extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_style( 'drift-thinkup-radio-image', trailingslashit( get_template_directory_uri() ) . 'admin/main/inc/controls/radio_image/control_radio_image.css', '', time() );
		}
