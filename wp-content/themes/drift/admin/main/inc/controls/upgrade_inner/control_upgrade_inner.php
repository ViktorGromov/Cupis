...
if( class_exists( 'WP_Customize_Control' ) ) {
	class drift_thinkup_customizer_customcontrol_upgrade_inner extends WP_Customize_Control {
		...
		public function enqueue() {
			wp_enqueue_style( 'drift-thinkup-control-upgrade', trailingslashit( get_template_directory_uri() ) . 'admin/main/inc/controls/upgrade_inner/control_upgrade_inner.css', '', time() );
		}
