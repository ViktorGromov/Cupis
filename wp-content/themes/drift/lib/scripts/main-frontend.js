...
function mainmenu(){
	...
	jQuery("#header .header-links li, #header-sticky .header-links li").hover(function(){
...
jQuery(window).load(function(){
	...
	if ( jQuery(window).width() > 768 && jQuery( 'body' ).hasClass( 'header-sticky' ) ) {
		...
		jQuery(window).scroll(function() {
			...
			var siteheader_height    = jQuery( '#body-core-header' ).height();
...
/* ----------------------------------------------------------------------------------
	WOOCOMMERCE - MOVE DROPDOWN MENU
---------------------------------------------------------------------------------- */

jQuery(window).load(function(){

	jQuery( '.woo-cart-menu-dropdown' ).each( function() {
		jQuery( this ).insertAfter( jQuery( this ).parent().find( '.woo-cart-menu-wrap' ) );
	});

	jQuery( '.woo-cart-menu-object' ).each( function() {
		jQuery( this ).insertBefore( jQuery( this ).parent().children( 'li:first-child') );
	});
});